...
import { E as fromJSON, F as resolveManifestCssLink, G as isRedirect, H as isDangerousProtocol, I as waitForReason, J as isNotFound, K as parseRedirect, L as _getRenderedMatches, M as getScriptPreloadAttrs, N as getStylesheetHref, O as toCrossJSONAsync, P as resolveManifestAssetLink, R as executeRewriteInput, S as require_jsx_runtime, U as isPromise, X as require_react, a as isSsrResponse, c as stripSsrResponseBody, i as disposeSsrResponse, k as toCrossJSONStream, n as bindSsrResponseToRequest, o as normalizeSsrResponse, p as RouterProvider, q as rootRouteId, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, z as invariant } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BGA8x94H.mjs");
...
var manifest = {
	"2560a55a5f26af31f201af9d6b5fcc9474a406b59825add3c4bb290c09c79d91": {
		functionName: "listLibrary_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"5b7b2fb0e1d643bc7346066c6ea15e315488cc1a96824da9b05935e059cc7aec": {
		functionName: "resolveBook_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"6485bb57ca7e15b3aa008e7903c2fec6e7f18bcdc237dbcc8fc68b6443cd4dd5": {
		functionName: "setBookCover_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"71904f5d43ff086368995bc63a4c798afb881b830784de7828d61daa4bed00f3": {
		functionName: "saveStudioChapter_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"84255b995f80e0ed73e6d603e5fae2e4affea4d7c90d158abce6e3fd55e24626": {
		functionName: "deleteStudioBook_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"8b7deecd246d7acca7b3b765d1be8406221754aefda47838d349dc3d9274fd04": {
		functionName: "saveChapterInserts_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"8c90a071a2d8b7c1e1dec1dbf3f62696021e5947972adf838bb4b5e4a0f96953": {
		functionName: "listMedia_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"8fa818629d9314f253ddbcde55fbe348ae389e77eb885babc5ec65a2d1d4cb4d": {
		functionName: "loadStudioChapter_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"9f244514620b4a1494df8e16e2459559f86927a96b5067e14260d577d278a006": {
		functionName: "deleteStudioChapter_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"a8518d1c731b3166bfb7614e466983d1a8710ce40a2ae4c90c3618b30f727e96": {
		functionName: "loadChapterInserts_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"a8e26e8f6a27d62263133905362563ca0db18400f87d0c4f504e39c0f495a86f": {
		functionName: "deleteMedia_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"af4dc59754256805cb367ba4b44f0757eb4c317711754f756c689184930639b1": {
		functionName: "getMediaRecord_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"c6b41aa2de4cd33fc5a79a82dd62a33b9b3ec2ce8e9d463dead3ace1a9bc480b": {
		functionName: "createBook_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"d60940ded800e029b46c3a1109af670892225ef84506186fbc10ce353d7db93a": {
		functionName: "createMedia_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	},
	"ed10c078eb879841a25a4701d760afee8b52575522b3918b782aa5b5ddb3d908": {
		functionName: "updateBook_createServerFn_handler",
		importer: () => import("./library-api-DnhDhDPy.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DJg4bJt1.mjs").then((n) => n.t),
